...
export const copyPages: CopyPage[] = [
  ...
  },
  {
    ...
    title: "预约页",
    path: "/booking",
    note: "顾客会在这一页完成选择类型、查看价格、查看档期和联系。",
    fields: [
      f("bookingEyebrow", "顶部英文小字"), f("bookingTitle", "页面主标题"), f("bookingLead", "页面说明", true), f("bookingStep1Label", "第一步标签"), f("bookingStep1Title", "第一步标题"), f("bookingSelectAction", "入口卡片按钮"),
      ...
      f("bookingPricingLabel", "价格步骤标签"), f("bookingPricingTitle", "价格步骤标题"), f("bookingPricingDetailAction", "详细说明链接"), f("bookingPromoLabel", "优惠区小字"), f("bookingPromoTitle", "优惠区标题"), f("bookingAvailabilityLabel", "档期步骤标签"),
      f("bookingPrepareHint", "联系前提示", true), f("bookingPrepare1Title", "联系提示 1 标题"), f("bookingPrepare1Text", "联系提示 1 说明", true), f("bookingPrepare2Title", "联系提示 2 标题"), f("bookingPrepare2Text", "联系提示 2 说明", true), f("bookingPrepare3Title", "联系提示 3 标题"), f("bookingPrepare3Text", "联系提示 3 说明", true),
      f("bookingContactLabel", "联系步骤标签"), f("bookingContactTitle", "联系步骤标题"), f("bookingContactReassurance", "联系区低压力提示", true),
