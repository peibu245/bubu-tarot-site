...
export const typographyPresets: Array<{ id: string; name: string; note: string; settings: TypographySettings }> = [
  ...
  { id: "modern", name: "清爽现代", note: "标题和正文统一使用黑体", settings: { ...defaultTypography, headingFont: "clean-sans", headingWeight: 700, letterSpacing: 0.02, lineHeight: 1.78 } },
  { id: "editorial", name: "安静书刊", note: "标题与正文都使用宋体", settings: { ...defaultTypography, bodyFont: "book-serif", bodyScale: 1.02, letterSpacing: 0.02, lineHeight: 1.95 } },
